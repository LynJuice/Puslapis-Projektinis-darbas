                ...
                <div class="row portfolio-container" data-aos="fade-up">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="{{ $portfolio->Pic_path}}" class="img-fluid" alt="">
                            <div class="portfolio-links">
                                <a href="{{ $portfolio->Pic_path }}" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 1"><i class="bx bx-plus"></i></a>
                                <a href="{{ route('portfolio.show', $portfolio) }}" title="More Details"><i class="bx bx-link"></i></a>
                            </div>
                        </div>
                    </div>
                    @endforeach
